...
export default function CollectionProductHeader({
	...
	return (
		<div className="relative h-[400px] md:h-full  md:min-h-[70vh] min-h-[400px]">
			{/* Background Image */}
			...
			{/* Header */}
			<header className="absolute top-0 left-0 right-0 z-20 mt-6 md:mt-20">
			...
			<div className="relative z-30 flex items-center justify-center h-[calc(100vh-450px)] md:h-[calc(100vh-120px)] px-4 sm:px-8">
