export default function DutchDesignSection() {
	return (
		<section className="bg-secondary px-6 md:px-20 py-16 md:py-24">
			<div className="max-w-6xl mx-auto">
				<div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8 items-start md:items-center justify-between">
					...
					<div className="flex items-center mb-6 md:mb-0 md:col-span-4">
						<div className="w-8 md:w-12 h-px bg-gray-300 mr-3 md:mr-4"></div>
						<div className="text-xs md:text-sm text-ternary tracking-widest font-light">
							Design
						</div>
					</div>
					...
					<div className="md:col-span-8">
						<div className="flex flex-col md:flex-row gap-8 md:gap-24 mb-8">
							...
							<div>
								<h2 className="text-4xl sm:text-5xl md:text-6xl font-light text-ternary font-[Gifilka] leading-tight tracking-wide">
									Dutch
									<br />
									Design
								</h2>
							...
							<div className="mt-6 md:mt-20">
								<h3 className="text-xl sm:text-2xl font-light text-ternary font-[Gifilka] leading-tight tracking-wide">
									Hand made
									<br />
									in Belgium
								</h3>
						...
						{/* Description Text */}
						<div className="space-y-4 text-ternary text-sm md:text-base leading-relaxed max-w-3xl">
							<p>
