...
export default function DutchDesignSection() {
  return (
    <section className="px-4 py-16 md:py-24 bg-[#4D4D4D] flex items-center justify-center">
      <div className="w-full flex items-center justify-center">
        <div>
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8 items-start md:items-center">
            ...
            <div className="flex items-center mb-6 md:mb-0 md:col-span-2">
            ...
            <div className="md:col-span-10">
              ...
              {/* Description Text */}
              <div className="space-y-4 text-[#F0E6E2] text-sm md:text-base leading-relaxed max-w-2xl">
                <p>
                  ...
                  process. Dutch Design by Bas Coppelmans combined with the hard
                  work and pride of our Belgian steelworkers. The best of both
                  worlds, because what's good doesn't have to come from far
                  away. Bas, Chief Studio Design, always seeks the perfect
                  balance in minimalism and works unconventionally during his
                  design process.
                </p>
              </div>
            </div>
